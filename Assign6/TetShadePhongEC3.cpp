// TetShadePhongEC3.cpp: Phong-shaded tetrahderon
...
void main(int argc, char **argv) {
    ...
    glutCreateWindow("Phong-shaded tetrahderon, infinite light source");
    glewInit();
